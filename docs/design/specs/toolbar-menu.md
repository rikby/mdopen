...
| `>= 768px` | `[Dark/Light] [☰]`, fixed top-right | right-aligned popover, minimum width fits longest select |
...
- Clicking outside the toolbar/menu closes the menu.
- Existing select labels remain visible inside the panel.
...
| border | existing `rgba(128, 128, 128, ...)` pattern | toolbar, panel, selects |
